...
/**
 * This is the loader generated by Cal.com's embed snippet generator. The
 * previous implementation used a hand-rolled variant that pointed at the
 * wrong script endpoint (`cal.com/embed.js`). The current public embed SDK is
 * served from `app.cal.com/embed/embed.js`.
 */
